    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://github.com/xgh1996/BlogPhotos/master/min_photos/' + data.link[i];
          var src = 'https://github.com/xgh1996/BlogPhotos/master/photos/' + data.link[i];
        ...
        ulTmpl = ulTmpl + '<section class="archives album"><h1 class="year"><span id="datayear-datamonth">' + data.year + '��<em>' + data.month + '��</em></span></h1>\
